        ...
        <div className="group flex  relative gap-5 shadow-lg w-[600px]">
          ...
          <div className="py-5">
            ...
            <p className="flex items-center gap-1 font-semibold text-md pb-3 border-b-2 ">
              <CiCircleCheck color="red" size={20} />
              Spicy Souce
            </p>
...
export function RecentOrderFoodCart() {
  return (
    <>
      <h1 className="text-2xl w-[1300px] mx-auto pb-10 font-bold ">Recent Order</h1>
      <div className="flex flex-wrap w-[1300px] mx-auto justify-between gap-y-10 pb-14">
        {foodData.map((d) => (
          <div className="group gap-5 shadow-lg w-[410px] relative ">
            <div className="absolute flex items-center justify-between w-full p-3 z-20">
              <FaRegHeart
